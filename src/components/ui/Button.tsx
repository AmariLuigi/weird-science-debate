...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-brand-sea to-primary text-white shadow-lg hover:shadow-primary/30 hover:scale-105",
        secondary:
        ...
        outline:
          "border border-brand-sea/40 bg-transparent text-white hover:bg-brand-dark/30 hover:border-brand-sea/60",
        brand:
          "bg-brand-dark border border-brand-teal/30 text-primary hover:bg-brand-teal/20 hover:border-brand-teal/50",
      },
      size: {
